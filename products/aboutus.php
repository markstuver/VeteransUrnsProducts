...
if ($shop && $shop != "1") $templatefilename = "aboutvendor";
else $templatefilename = "aboutus";

// Check if a mobile device is being used...
$device = ashop_mobile();

// Print header from template...
if ($lang != $defaultlanguage && file_exists("$ashoppath$templatepath/$templatefilename-$lang.html")) ashop_showtemplateheader("$ashoppath$templatepath/$templatefilename-$lang.html");
else ashop_showtemplateheader("$ashoppath$templatepath/$templatefilename.html");

// Get page content...
$feature = "AShopAboutPage";
include "includes/product.inc.php";
$feature = "";

// Print footer from templates...
if ($lang != $defaultlanguage && file_exists("$ashoppath$templatepath/$templatefilename-$lang.html")) ashop_showtemplatefooter("$ashoppath$templatepath/$templatefilename-$lang.html");
else ashop_showtemplatefooter("$ashoppath$templatepath/$templatefilename.html");
?>