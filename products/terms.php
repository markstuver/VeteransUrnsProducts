...
if ($lang != $defaultlanguage && file_exists("$ashoppath$templatepath/terms-$lang.html")) ashop_showtemplateheader("$ashoppath$templatepath/terms-$lang.html");
else ashop_showtemplateheader("$ashoppath$templatepath/terms.html");

// Get page content...
$feature = "AShopTermsPage";
include "includes/product.inc.php";
$feature = "";

// Print footer from templates...
if ($lang != $defaultlanguage && file_exists("$ashoppath$templatepath/terms-$lang.html")) ashop_showtemplatefooter("$ashoppath$templatepath/terms-$lang.html");
else ashop_showtemplatefooter("$ashoppath$templatepath/terms.html");
?>