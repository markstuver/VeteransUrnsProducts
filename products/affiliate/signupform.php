            ...
            <form action=\"signup.php\" method=\"post\" name=\"signupform\">
              <table border=\"0\" cellspacing=\"0\" cellpadding=\"3\" width=\"440\">
                ...
                <tr> 
                  ...
                  <td class=\"ashopaffiliatefield\"> 
                    <select name=\"country\" onchange=\"switchStates(document.getElementById('state'),document.signupform.province,document.signupform.country.value);\" onClick=\"if (typeof(countryinterval) != 'undefined') window.clearInterval(countryinterval);\"><option  value=\"none\">choose country</option>";
                ...
                <tr id=\"stateselector\" style=\"display:none\"> 
                  ...
                  <td class=\"ashopaffiliatefield\"> 
                    <select name=\"state\" id=\"state\"><option value=\"none\">".CHOOSESTATE."</option></select>
                  </td>
                </tr>
