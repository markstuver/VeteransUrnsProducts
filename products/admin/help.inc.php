...
// configure.php tooltip text and help links
	...
	$tip1 = "To reset the AShop Administration Panel password, enter the current password, then enter the new one twice, and then submit this page.";

	$tip2 = "The <b>Contact Information</b> appears within the shopping cart pages and emailed notices. Note that this information is used to initially populate the <i>Thank You Message</i> when a new payment option is created. After a payment option is created, if you change this contact information here, it does not automatically change the Thank You Message, which is set for each payment option.";

	$tip3a = "The <b>Currency</b> setting changes the currency symbol that appears in the shopping cart and in receipts and order notices. It also changes the payment options that are available. <b>Warning!</b> Changing this setting deletes payment options that were set for the previous currency.";

	$tip3b = "The <b>Catalog mode</b> is typically set to <i>Shopping cart</i>, which enables selection of more than one product per order and any quantity of each product. Use <i>Single product order</i> to go straight to checkout when a product is put in the cart, allowing only allow one product per order. Use <i>Single product shopping cart</i> to disable the quantity box and set the quantity of each added product to 1.";
	$help3b = "http://www.ashopsoftware.com/help/ashopv/product_catalogue.htm";

	$tip3i = "If your product details pages show up as a page not found error, you will need to deactivate the search engine friendly URLs.";

	$tip3c = "The <b>Wishlist</b> option allows customers to save items they want in a list and retrieve them later by logging in with their email address and password.";
	$help3c = "http://www.ashopsoftware.com/help/ashopv/savecart.htm";

	$tip3d = "When the <b>Confirm Add To Cart</b> pop-up window is enabled, customers must always click to confirm each product that is put in the cart. When it is disabled, the window will only require a response if the product requires attribute selection or terms of sale (license) agreement.";

	$tip3e = "The <b>Link From Thank You Page</b> appears within the payment confirmation page below the Thank You Message, which is set for each payment option. This is the return link to your site from the payment confirmation page, which in some cases is hosted securely by the payment gateway.";

	$tip3f = "<b>Do you like this program?</b><br><br> Profit by letting other merchants know about us when they visit your shopping cart.<br><br>Join the AShop Software affiliate program and enter your ID here. A small &quot;Powered by AShop&quot; image with an affiliate tracking link will appear below the category listings in the catalogue. When the link is clicked, a new browser will open so that your site is still open also. Commissions are paid out approximately 60 days following each order.<br><br>If nothing is entered here, the image and link does not appear in the catalogue.";
	$help3f = "http://www.ashopsoftware.com/ashop-affiliate.htm";
	
	$tip3g = "Sets the number of items to be displayed on one page in the product catalogue. If more than this number of items exist in the chosen category or search result, the items will be split up on separate pages that can be accessed by clicking a page number.";

	$tip3h = "<b>TeleSign</b> is a pre-payment processing telephone verification service, which can substantially reduce fraudulent credit card transactions. TeleSign verifies that the customer phone number is legitimate before sending the payment information to the payment processor. It stops most third-world credit card fraud and ensures that payment transactions are not submitted as part of an automated process.<br><br>Customers receive an automated phone call and are given a unique 4 digit pass number, which must then be entered into the payment form before the payment information is sent to the payment gateway for processing. Click on the TeleSign Customer ID link for more information and to sign up.";
	$help3h = "http://www.ashopsoftware.com/telesign.htm";

	$tip4 = "The <b>Wholesale Catalogue</b> shares the same database of products as retail, but the prices are set separately. Products can be set as active or not separately for the retail and wholesale catalogs.";
	$help4 = "http://www.ashopsoftware.com/help/ashopv/wholesalecatalogue.htm";

	$tip5 = "<b>Allow Download For</b><br>Passwords for downloadable products are e-mailed upon receipt of payment. An active password is required to access the downloadable product files. The password will expire after the number of days that is set in the <i>Allow Download For</i> box. Setting the allowed download days to 0 removes the time limit.<br><br><b>Allow (quantity) Downloads Per Product</b><br>Each product file may be downloaded this many times within the allowed number of days. Set it to 0 to allow an unlimited number of downloads.";
	
	$tip6 = "If the <b>Random Key Code Selection</b> is checked, key codes are assigned to customers in random order. If the box is unchecked, the key codes are used in the ascending order of the original key code text file.";
	$help6 = "http://www.ashopsoftware.com/help/ashopv/keycodeproducts.htm";
	...
	$tip8 = "<b>Product Flags</b> can be used to indicate for instance availability of a product or other useful information of your choice.";

	$tip9 = "<b>Shopping Mall</b> Let other businesses sell through your shop. The default commission level is the percentage of the sales that you will pay your member shop owners. The rest is kept by you as payment for this service.";

	$tip10 = "<b>SAASU</b> is a web based accounting system. AShop will check inventory levels in your SAASU file and send all sales to SAASU. To activate this integration you will need a web service access key provided by SAASU and a file id for your accounting file. To send sales to your SAASU account you will also need to specify the bank account you wish your sales to be credited to.";
	$help10 = "http://www.saasu.com/api/quick-start/";

	$tip11 = "With this option checked the checkout page will have an input field for discount coupon codes, if there are any. If you turn this off there will be a discreet link to a separate page for this instead, to avoid making customers feel they are being cheated.";

	$tip12 = "Enter a message about how the customer can get a discount coupon, for example to inform them of an ongoing promotional campaign. This will be shown just above the input field for the discount coupon code.";

	$tip13 = "Give returning customers a reward in the form of <b>virtual cash</b> that can be applied as a discount on future orders. Set this to: 0, to disable loyalty rewards.";

	$tip14 = "Set the meta tags of your pages. Product pages can have their own meta tags.";
	
	$tip15 = "Change the RSS feed URL of the News box on the storefront.";

	$tip16 = "<b>Application Text</b> content appears on the shopping mall member sign up page. It is commonly used to disclose the terms of the shopping mall and to invite new vendors to join. HTML for images and hyperlinks can be included in this area.";

	$tip18 = "<b>MaxMind minFraud</b> is an online service that can help you check the probability of fraud on an order or customer registration. To use it you need to subscribe to the service, which gives you a license key. If an order gets a risk score higher than your threshold value, it will be registered as a pending order, until you activate it.";

	$tip19 = "<b>MaxMind minFraud GeoIP check</b> is a separate service that can be used to verify that a customer is really located where he/she claims to be and requires another subscription and license key. Activating this will deny customers to be registered if their IP is located in a different country than the one they use when signing up.";

	break;

	case "advancedoptions":

		$tip1 = "The <b>Shop URL</b> is automatically set by the install.php script in most cases.  This setting is used by the program to construct links.<br><br>If it is not correct, payment responses will not be received and orders may not be completed.<br><br><b>Warning!</b> If this URL is on a secure SSL connection (https instead of http) some features may not work properly! To avoid trouble make sure the main shopping cart scripts are installed on a regular http connection.";
		...
		$tip4 = "<b>Path To ListMessenger</b><br><br>Set this path only if ListMessenger is installed on the same server. Enter the complete server path to the directory where ListMessenger is installed. Include a leading / and no trailing slash. Here are some examples.<br> /home/httpd/vhosts/yourdomain.com/httpdocs/listmessenger<br>/home/user/public_html/listmessenger";
		$help4 ="http://www.listmessenger.com/index.php";

		$tip5 = "<b>URL To ListMail Pro</b><br><br>Enter the URL to where ListMail Pro is installed. Here is an example.<br> http://www.yourdomain.com/listmail";
		$help5 ="http://hop.clickbank.net/hop.cgi?ashop/mfware";

		$tip6 = "<b>Path To phpBB</b><br><br>Set this path only if phpBB is installed on the same server. Enter the complete server path to the directory where phpBB is installed. Include a leading / and no trailing slash. Here are some examples.<br>/home/httpd/vhosts/yourdomain.com/httpdocs/phpBB<br> /home/user/public_html/phpBB<br><br><b>Important!</b> The phpBB URL must also be set below";
		$help6 ="http://www.phpbb.com";

		$tip7 = "<b>URL To phpBB</b><br><br>Set this URL only if phpBB is installed on the same server. Enter the complete URL to the directory where phpBB is installed. Include the http:// at the beginning of the URL.<br>For instance<br>http://yourdomain.com/phpBB";

		$tip8 = "<b>Path To PA+</b><br><br>Set this path only if Password Adminstrator + is installed on the same server. Enter the complete server path to the directory where the PA+ program files are installed. Include a leading / and no trailing slash. Here are some examples.<br> /home/httpd/vhosts/yourdomain.com/cgi-bin/pa<br>/home/user/cgi-bin/pa";
		$help8 ="http://illmatic.net/";

		$tip9 = "<b>Path To AutoResponse Plus</b><br><br>Set this path only if AutoResponse Plus is installed on the same server. Enter the complete server path to the directory where the ARP program files are installed. Include a leading / and no trailing slash. Here are some examples.<br> /home/httpd/vhosts/yourdomain.com/cgi-bin/arp3<br>/home/user/cgi-bin/arp3";
		$help9 ="http://www.ashopsoftware.com/autoresponse-plus-programmable-autoresponder.htm";

		$tip10 = "<b>Path To Password Robot</b><br><br>Set this path only if Password Robot is installed on the same server. Enter the complete server path to the directory where the Password Robot program files are installed. Include a leading / and no trailing slash. Here are some examples.<br> /home/httpd/vhosts/yourdomain.com/cgi-bin/pr<br>/home/user/cgi-bin/pr";
		$help10 ="http://www.passwordrobot.com/";

		$tip11 = "The <b>Secure File System Path</b> is automatically set by the install.php to the same path used for the File System Path setting. It should be the complete server path to the directory where sensitive areas of AShop, such as the products directory and directories containing subscription passwords, are stored with a leading / and no trailing slash. Here are some examples.<br>/home/httpd/vhosts/yourdomain.com/ashop<br> /home/user/ashop.<br><br>This setting should preferrably be changed to a directory outside the publicly accessible document root. It is used by the program to write product files and product images to a directory. If the path is incorrect, product files and images will not save when adding or editing products.";

		$tip12 = "<b>Path To Infinity Responder</b><br><br>Set this path only if Infinity Responder is installed on the same server. Enter the complete server path to the directory where the Infinity Responder program files are installed. Include a leading / and no trailing slash. Here are some examples.<br> /home/httpd/vhosts/yourdomain.com/responder<br>/home/user/responder";
		$help12 ="http://www.infinityresponder.org/";

		$tip13 = "If a user moves a product through the Up or Top buttons in Edit Catalog and loses connection or closes his/her browser before it is completed, the feature can become locked. If the Up or Top buttons are not functioning you can click Unlock here to unlock them.";

		$tip14 = "If a user generates HTML product detail pages and loses connection or closes his/her browser before it is completed, the feature can become locked. If the Make HTML feature can not be used you can click Unlock here to unlock it.";

		$tip15 = "Post Affiliate Pro is an advanced affiliate tracking system with more features than the one built in to AShop. Set this URL and edit the paptrack.php script to start using it with AShop.";
		$help15 ="http://www.qualityunit.com";

		$tip16 = "<b>URL To Email Marketer</b><br><br>Enter the URL to where Interspire Email Marketer is installed. Here is an example.<br> http://www.yourdomain.com/emailmarketer<br>Set the User and Token to the ones you can configure in your Interspire Email Marketer control panel.";
		$help16 ="http://www.interspire.com/emailmarketer";

		$tip17 = "<b>Authorization Code for AWeber</b><br><br>Get your authorization code by clicking the Authorization Code link and logging in to your AWeber account. Then enter the code in this box to activate AWeber integration which lets you sign customers up with your AWeber lists when they buy from you.";

		$tip18 = "<b>API Key for MailChimp</b><br><br>Get your API key by logging in to your MailChimp account. Then open the page Account->API Keys & Authorized Apps. Click Add A Key if you do not already have one and then copy and paste the key into the box in your AShop. This will let you sign up customers with your MailChimp lists when they buy from you.";
	...
	break;
        ...
        case "layout":
				...
				$tip11 = "Shows products from subcategories in their parent category. This option turns the subcategories into a way to refine the product list rather than separate categories with separate content.";
