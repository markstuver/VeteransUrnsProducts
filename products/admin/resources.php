...
echo $header."<div class=\"heading\">AShop Resources</div><table cellpadding=\"0\" align=\"center\"><tr><td>";
...
$result = @mysqli_query($db, "SELECT licensekey FROM user WHERE userid='1'");
$licensekey = @mysqli_result($result, 0, "licensekey");
...
else if ($error == 2) echo "<p><font face=\"Arial, Helvetica, sans-serif\" color=\"#900000\"><b>There is currently no information available for this version of AShop!</font></p>";
else echo $res;
