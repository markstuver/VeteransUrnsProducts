...
class UploadHandler
{
    ...
    function __construct($uploaddir = null, $uploadurl = null, $options = null, $initialize = true, $error_messages = null) {
		if (empty($uploaddir)) $uploaddir = dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/';
		if (empty($uploadurl)) $uploadurl = $this->get_full_url().'/files/';
        $this->options = array(
