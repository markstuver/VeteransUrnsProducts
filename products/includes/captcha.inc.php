...
if(isset($version[0]) && $version[0]>1 && function_exists('imagecreatefromjpeg') && function_exists('imagecreatefromgif') && function_exists('imagecreatetruecolor')) $gdversion = 2;
else $gdversion = 0;

// Only continue if GD reporting is not requested...
if (empty($checkgd)) {
	...
	// If GD is available generate captcha code image...
	if (!$_GET["cid"] && $gdversion == 2) {
